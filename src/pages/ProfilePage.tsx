...
export default function ProfilePage({ currentProfile }: ProfilePageProps) {
  ...
  return (
    <div className="pt-24 pb-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      {/* Cover + Avatar Card */}
      <section className="bg-bg-card border border-white/5 rounded-[32px] overflow-hidden">
        <div className="h-40 relative">
          ...
          {isOwnProfile && (
            <button
              ...
              className="absolute top-4 right-4 px-4 py-2 rounded-xl bg-black/20 backdrop-blur-md border border-white/10 text-xs font-medium hover:bg-black/40 transition-all"
            >
              Edit Profile
            </button>
          )}
        ...
        <div className="px-5 sm:px-8 pt-5 pb-8">
          <div className="flex flex-wrap items-end justify-between gap-3 mb-6">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-accent-teal to-accent-purple p-1 border-4 border-bg-card shadow-lg shadow-black/20">
              {profile.avatar_url ? (
                <img
            ...
            <div className="flex flex-wrap justify-end gap-2 ml-auto">
              ...
              {isOwnProfile ? (
                <button
                  onClick={() => setEditingProfile(true)}
                  className="bg-accent-teal hover:bg-[#00f5b4] text-bg-base px-5 sm:px-6 py-2.5 rounded-xl text-sm font-bold font-display transition-all flex items-center gap-2 shrink-0"
                >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="bg-accent-teal hover:bg-[#00f5b4] text-bg-base px-8 py-2.5 rounded-xl text-sm font-bold font-display transition-all"
                  >
              ...
              return (
                <div key={recommendation.id} className="bg-bg-elevated rounded-2xl p-6 border-l-4 border-accent-teal space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#091F14] text-accent-teal flex items-center justify-center font-bold text-xs">
