...
export default function SettingsPage() {
  ...
  return (
    <div className="pt-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 space-y-6">
      ...
      <section className="bg-bg-card border border-white/5 rounded-3xl p-6 space-y-5">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            disabled={saving}
            className="bg-accent-teal hover:bg-[#00f5b4] text-bg-base px-5 py-2.5 rounded-xl text-sm font-bold transition-all disabled:opacity-50 flex items-center gap-2"
          >
