...
export function MyCoursesPage() {
  ...
  return (
<div className="min-h-screen bg-bg-base text-text-primary px-6 md:px-8 pt-24 pb-10">
        <button
...
<h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-green-400 to-teal-400 bg-clip-text text-transparent">          My Courses
        ...
        <p className="text-text-secondary">Track your learning journey across all instructors</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {filteredCourses.map((course) => (
            <div
              key={course.id}
              className="group relative bg-bg-card border border-white/10 rounded-2xl p-6 overflow-hidden hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10"
            >
              {/* Accent Line */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-text-primary mb-1">{course.title}</h3>
        ...
        <div className="text-center py-20">
          ...
          <p className="text-text-secondary mb-4">No courses found in this category</p>
          <button
