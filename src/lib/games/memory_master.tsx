...
const CSS = `
  .mm-wrap { min-height:100vh; display:flex; justify-content:center; align-items:center; padding:20px;
    background:linear-gradient(135deg,#040A0A,#040A0A,#040A0A); font-family:'Segoe UI',sans-serif; }
  ...
  .mm-header { background:linear-gradient(135deg,#22F2EF,#C923F8); padding:30px; text-align:center; color:#fff; }
  ...
  .mm-side { flex:1; min-width:280px; background:#040A0A; padding:30px; border-left:3px solid rgba(255,255,255,0.2); }

  .mm-setup { text-align:center; }
  .mm-setup input { display:block; margin:0 auto 16px; padding:14px 20px; font-size:1.1em;
    border:3px solid #22F2EF; border-radius:10px; width:100%; max-width:300px; transition:.3s;
    background:linear-gradient(135deg,#22F2EF,#C923F8); color:#fff; }
  .mm-setup input:focus { outline:none; border-color:#C923F8; transform:scale(1.02); }

  .mm-score-box { text-align:center; padding:20px; background:linear-gradient(135deg,rgba(201,35,248,0.16),rgba(201,35,248,0.28));
    border-radius:14px; margin-bottom:20px; }
  .mm-score-label { font-size:1.1em; color:#FFFFFF; margin-bottom:6px; font-weight:600; }
  .mm-score-value { font-size:3em; font-weight:700; color:#22F2EF; }

  .mm-status { text-align:center; padding:14px; background:rgba(34,242,239,0.15); border-radius:10px;
    margin-bottom:20px; font-size:1.15em; font-weight:700; color:#22F2EF; }
  ...
  .mm-color-btn.red    { background:linear-gradient(135deg,#C923F8,#C923F8); }
  .mm-color-btn.blue   { background:linear-gradient(135deg,#22F2EF,#22F2EF); }
  .mm-color-btn.green  { background:linear-gradient(135deg,#49DC7A,#22F2EF); }
  .mm-color-btn.yellow { background:linear-gradient(135deg,#C923F8,#C923F8); }
  ...
  .mm-btn { padding:14px 28px; font-size:1.05em; border:none; border-radius:10px; cursor:pointer;
    ...
    background:linear-gradient(135deg,#22F2EF,#C923F8); color:#fff;
    box-shadow:0 4px 14px rgba(34,242,239,.4); transition:.3s; }
  .mm-btn:hover:not(:disabled) { transform:translateY(-2px); box-shadow:0 6px 20px rgba(34,242,239,.6); }
  .mm-btn:disabled { opacity:.5; cursor:not-allowed; }

  .mm-gameover { background:linear-gradient(135deg,#22F2EF,#C923F8); padding:36px;
  ...
  .mm-leaderboard h2 { font-size:1.7em; color:#FFFFFF; margin-bottom:18px; text-align:center; }
  ...
  .mm-lb-item.rank-1 { background:linear-gradient(135deg,#C923F8,#C923F8); border:2px solid #C923F8; }
  .mm-lb-item.rank-2 { background:linear-gradient(135deg,rgba(255,255,255,0.8),rgba(255,255,255,0.7)); border:2px solid rgba(255,255,255,0.8); }
  .mm-lb-item.rank-3 { background:linear-gradient(135deg,#49DC7A,#49DC7A); border:2px solid #49DC7A; }
  .mm-rank { font-size:1.3em; font-weight:700; color:#22F2EF; width:36px; }
  .mm-lb-name { flex:1; font-weight:700; color:#FFFFFF; }
  .mm-lb-score { font-weight:700; color:#22F2EF; }
  .mm-empty { text-align:center; padding:32px 16px; color:rgba(255,255,255,0.65); }

  @media(max-width:768px){
    .mm-body { flex-direction:column; }
    .mm-side { border-left:none; border-top:3px solid rgba(255,255,255,0.2); }
